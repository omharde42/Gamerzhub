...
export function getGameConfig(gameId: string): GameCapabilityConfig | undefined {
  return CANONICAL_GAMES_REGISTRY[gameId.toLowerCase()];
}

export function getAllGames(): GameCapabilityConfig[] {
